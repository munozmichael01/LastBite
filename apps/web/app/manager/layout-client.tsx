...
import {
  LayoutDashboard, CalendarCheck, Tag, ShoppingBag, Settings,
  BarChart3, Menu, X, ChevronLeft, LayoutGrid, BookOpen, LogOut,
} from "lucide-react"
...
const navItems = [
  ...
  { href: "/manager/estadisticas", label: "Estadísticas",    icon: BarChart3 },
    ...
    <div className="flex min-h-[calc(100vh-4rem)]">
      ...
      >
        <div className="flex items-center justify-between border-b border-border px-4 py-4 lg:py-5">
          <div>
            <p className="text-sm font-semibold text-foreground">{restauranteName}</p>
      ...
      <div className="flex flex-1 flex-col">
        <div className="flex h-14 items-center border-b border-border px-4 lg:hidden">
          ...
          <span className="ml-3 text-sm font-semibold text-foreground">{restauranteName}</span>
        </div>
