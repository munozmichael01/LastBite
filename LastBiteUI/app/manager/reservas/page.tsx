...
const allReservations: ManagerReservation[] = [
  { id: "R-001", name: "Maria Lopez", email: "maria@email.com", phone: "+34 612 345 678", guests: 4, date: "2026-02-14", time: "13:30", status: "confirmed", promotion: "-30% Almuerzo", code: "LB-A1B2" },
  { id: "R-002", name: "Carlos Ruiz", email: "carlos@email.com", phone: "+34 623 456 789", guests: 2, date: "2026-02-14", time: "14:00", status: "confirmed", code: "LB-C3D4" },
  { id: "R-003", name: "Ana Martinez", email: "ana@email.com", phone: "+34 634 567 890", guests: 6, date: "2026-02-14", time: "14:30", status: "seated", notes: "Mesa junto a la ventana", code: "LB-E5F6" },
  { id: "R-004", name: "Pedro Sanchez", email: "pedro@email.com", phone: "+34 645 678 901", guests: 3, date: "2026-02-14", time: "20:00", status: "confirmed", promotion: "2x1 Cenas", code: "LB-G7H8" },
  { id: "R-005", name: "Laura Gomez", email: "laura@email.com", phone: "+34 656 789 012", guests: 2, date: "2026-02-14", time: "21:00", status: "confirmed", code: "LB-I9J0" },
  { id: "R-006", name: "Javier Fernandez", email: "javier@email.com", phone: "+34 667 890 123", guests: 5, date: "2026-02-13", time: "14:00", status: "completed", code: "LB-K1L2" },
  { id: "R-007", name: "Sofia Torres", email: "sofia@email.com", phone: "+34 678 901 234", guests: 2, date: "2026-02-13", time: "21:00", status: "no_show", code: "LB-M3N4" },
  { id: "R-008", name: "Diego Herrera", email: "diego@email.com", phone: "+34 689 012 345", guests: 4, date: "2026-02-13", time: "13:30", status: "cancelled", code: "LB-O5P6" },
]
